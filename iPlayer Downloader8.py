...
def CheckGetIPlayerInstalled():
    command = "get_iplayer"
    
    if not is_command_available(command):
        print("get_iplayer is not found")
        print("Please check it is installed correctly")
        print("See https://github.com/get-iplayer/get_iplayer for installer")
        input()
        exit()
